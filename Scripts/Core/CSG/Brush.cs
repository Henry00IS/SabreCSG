...
namespace Sabresaurus.SabreCSG
{
    ...
    public abstract class Brush : BrushBase
    {
        ...
        public abstract void RecalculateIntersections(List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool isRootChange);
        ...
        public abstract void PrepareToBuild(List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool forceRebuild);

        protected static List<Brush> CalculateIntersectingBrushes(Brush sourceBrush, List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool isCollisionPass)
        {
            ...
            // query the octree to find potential candidates instead of iterating over all brushes:
            List<Brush> intersectingBrushCandidates = new List<Brush>();
            brushBoundsOctree.GetColliding(intersectingBrushCandidates, sourceBrush.GetBoundsTransformed());
            brushes = intersectingBrushCandidates;
        ...
        /// <summary>DEPRECATED - <see cref="PrepareToBuild(List{Brush}, bool)"/> is obsolete and was replaced by <see cref="PrepareToBuild(List{Brush}, BoundsOctree{Brush}, bool)"/>!</summary>
        [Obsolete("Replaced by PrepareToBuild(List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool forceRebuild)!")]
        public virtual void PrepareToBuild(List<Brush> brushes, bool forceRebuild) { Debug.LogError("DEPRECATED METHOD!"); }

        /// <summary>DEPRECATED - <see cref="CalculateIntersectingBrushes(Brush, List{Brush}, bool)"/> is obsolete and was replaced by <see cref="CalculateIntersectingBrushes(Brush, List{Brush}, BoundsOctree{Brush}, bool)"/>!</summary>
        [Obsolete("Replaced by CalculateIntersectingBrushes(Brush sourceBrush, List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool isCollisionPass)!")]
        protected static List<Brush> CalculateIntersectingBrushes(Brush sourceBrush, List<Brush> brushes, bool isCollisionPass) { Debug.LogError("DEPRECATED METHOD!"); return new List<Brush>(); }

        /// <summary>DEPRECATED - <see cref="RecalculateIntersections(List{Brush}, bool)"/> is obsolete and was replaced by <see cref="RecalculateIntersections(List{Brush}, BoundsOctree{Brush}, bool)"/>!</summary>
        [Obsolete("Replaced by RecalculateIntersections(List<Brush> brushes, BoundsOctree<Brush> brushBoundsOctree, bool isRootChange)!")]
        public virtual void RecalculateIntersections(List<Brush> brushes, bool isRootChange) { Debug.LogError("DEPRECATED METHOD!"); }
